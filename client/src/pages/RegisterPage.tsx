                    ...
                    <div className="form-group">
                        ...
                        <div className="input-wrapper">
                            ...
                            <input
                                type="email"
                                name="email"
                                className={`form-input ${errors.email || emailStatus === 'taken' ? 'error' : emailStatus === 'available' ? 'success' : ''}`}
                            ...
                            <span className="input-status">
                                ...
                                {emailStatus === 'available' && <span style={{ color: 'var(--color-success)' }}><CheckIcon /></span>}
                                {emailStatus === 'taken' && <span style={{ color: 'var(--color-error)' }}><XIcon /></span>}
                            </span>
                        </div>
                        {errors.email && <span className="form-error"><XIcon /> {errors.email}</span>}
                        {!errors.email && emailStatus === 'taken' && <span className="form-error"><XIcon /> Email already registered</span>}
                        {emailStatus === 'available' && <span className="form-success">Email is available</span>}
                    </div>
